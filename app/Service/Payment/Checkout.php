...
class Checkout
{
    ...
    public function payment(string $token, $customer, $amount)
    {
        ...
        $reference_number = Order::whereYear('created_at', '=', $now->year)->max('reference_number');
...
//        ]);
        ...
        $payment->success_url = 'https://furqanshop.com/promo-OxpPkDO-25/';
        $payment->failure_url = 'https://furqanshop.com/promo-OxpPkDO-25/';
